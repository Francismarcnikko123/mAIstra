...
class PreprocessConfig:
    ...
    # engage the branch, which is the design working as intended. The earlier
    # ON-vs-OFF byte-identical A/B (0.149 either way) was on that old cohort and
    # should be re-measured on the current set (set adaptive_denoise=False for a
    # clean A/B). The 2.2 trigger and the bond-vs-greenbook rationale above
    # still hold. See docs/ocr/QUALITY_GATE_REVIEW.md and the
