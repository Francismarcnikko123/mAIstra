...
- **Edit saved questions (2026-09-26):** *Edit* and *Validate test cases* on the question page open the form pre-filled; Save stays locked until validation passes; changing test cases on a graded question warns before its grades are cleared (Jayrald's trigger); an unsectioned question can be given a section and number, which puts older questions on the phone. Web 310/310. [Note](changes/2026-09-26-edit-questions.md)
