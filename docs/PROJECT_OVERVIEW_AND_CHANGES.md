...
- Verified: full Python suite **148/148** passes and `evaluate_cer` reproduces the pins exactly — clean_ws CER **0.099**, clean WER **0.328**, clean token accuracy **0.716**, green_writer10 clean_ws **0.061**. The matching aggregate is the proof the move changed no output.
